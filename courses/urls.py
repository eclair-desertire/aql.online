...
urlpatterns=[
    ...
    path('<int:pk>/delete/',courses.CourseOwnerView.as_view({'delete':'destroy'})),
    path('<int:pk>/update/',courses.CourseOwnerView.as_view({'put':'partial_update'})),
    path('create/',courses.CourseOwnerView.as_view({'post':'create'})),
